...
These rules bind the `cover-letter-writer` agent; the `application-verifier` checks against them. Market-specific additions (Anschreiben norms) are in `standards/dach_conventions.md`.
