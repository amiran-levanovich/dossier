...
- **The swap test, for when paraphrase goes too far.** Rephrasing is yours; four things are not. Put the CV's own words back into your sentence, and if the meaning *narrows*, you widened something: the **verb**, the **scope noun**, the **employer** and the **tense** must survive that swap. "Own the settlement *service* end to end" cannot become "hold the settlement *domain* end to end" — a domain is bigger than a service, and the CV never claimed it. The gate scores a widened verb or scope, a claim moved to another employer, or past work made current as MAJOR, so this is cheaper to get right than to repair.
