...
scripts/                     # deterministic helpers: cv (v4 slot map + verbatim assembly) · ats_coverage · tracker · trace_check · claim_ledger · master_diff · master_slots · session_metrics · release_audit · privacy_scan · machine_summary · eval_run/eval_score (+ _common, tests/)
